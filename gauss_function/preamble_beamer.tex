...
% Deep Forest Green - A PGreen sötétebb párja a mélységhez
\definecolor{PForest}{HTML}{4A6741} 

% Muted Sage - Egy átmenet a zöld és a szürke között
\definecolor{PSage}{HTML}{A3B18A}

% Dusty Teal - A kék és a zöld elegáns találkozása
\definecolor{PTeal}{HTML}{6D9788}

% Soft Terracotta - Melegség piros nélkül (inkább narancsos-agyagos)
\definecolor{PTerra}{HTML}{D4A373}

% Sand / Cream - Világosabb, mint az Orange, remek háttérszín
\definecolor{PSand}{HTML}{F1EAD7}

% Slate Blue - Egy füstösebb, szürkésebb kék
\definecolor{PSlate}{HTML}{708294}
