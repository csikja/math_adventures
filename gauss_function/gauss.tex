...
\begin{center}
  \input{./tikz/gauss_function_general.tex}
\end{center}
\end{frame}
...
\[\hl{s_n = \arctan\left(\frac{1}{\sqrt{n-1}}\right), \quad g_n(x) = \cos^n \left( \arctan\left(\frac{1}{\sqrt{n-1}}\right) x\right) \quad n\ge 2}\]
 \begin{center}
    \input{./tikz/cos_series_scaled.tex}
    \end{center}
\end{frame}
...
A pozitív inflexiós pont
\[s_n = \sqrt{\frac{2}{|h''(0)|s}} \cdot \frac{1}{\sqrt{2n-1}} \sim \frac{1}{\sqrt{n\cdot|h''(0)|}}\]
kihasználva, hogy $h'(0)=0$ és $h''(0)<0$
\[g_n(x)=h(s_n x)^n \sim \left(1-\frac{x^2}{2n}\right)^n, \quad x\in (-\sqrt{2n}, \sqrt{2n})\]
és így
